  ...
  function nav1() {
    ...
    return (
          ...
          <label for="choosetemplate" className={style.dropdown}>Template</label>
            ...
            <textarea id="text1" name="text1" style={{width:"46vh",height: "45vh",border: "0px solid black",backgroundColor:"gold",padding:"10px"}}></textarea>
            </div>
            ...
            <textarea id="text2" name="text2" style={{width:"40vh",height: "45vh",border: "0px solid black",backgroundColor:"gold",padding:"10px"}}></textarea>
            </div>
